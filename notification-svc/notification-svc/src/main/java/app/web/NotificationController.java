...
public class NotificationController {
    ...
    public ResponseEntity <NotificationPreferencesResponse> upsertNotificationPreference(@RequestBody UpsertNotificationPreference upsertNotificationPreference) {
        ...
        // entity -> dto
        NotificationPreferencesResponse responseDto = DtoMapper.fromNotificationPreference (notificationPreference);
    ...
    public ResponseEntity <NotificationPreferencesResponse> getUserNotificationPreference(@RequestParam(name = "userId") UUID userId) {
